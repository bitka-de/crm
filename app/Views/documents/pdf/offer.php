...
<body>
    ...
    <h2>Details</h2>
    <div class="box">
        <div class="row"><strong>Gueltig bis:</strong> <?= $this->escape((string) ($document['valid_until'] ?? '-')) ?></div>
        <div class="row"><strong>Status:</strong> <?= $this->escape((string) ($document['status'] ?? 'Entwurf')) ?></div>
        <div class="total">Gesamtbetrag: <?= $this->escape((string) ($document['amount_eur'] ?? '0.00')) ?> EUR</div>
    </div>
